CLASS zcl_ce_asset_tg_rp DEFINITION
  PUBLIC
  FINAL
...
CLASS ZCL_CE_ASSET_TG_RP IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    "2. SELECT
    zcl_ce_asset_tg_rp_implement=>select( EXPORTING it_filters      = lt_filters
                                          IMPORTING et_result       = DATA(lt_result) ).
    "3. RESPONSE
    zcl_ce_asset_tg_rp_implement=>response( EXPORTING io_request  = io_request
